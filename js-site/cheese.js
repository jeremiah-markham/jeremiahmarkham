...
//     if (event.key === "Enter") {
//         // Prevent the default action, if needed (e.g., form submission and page refresh)
//         event.preventDefault(); 
//         // Call your desired function or trigger a button click
//         validateCheese();
//     }
//     });
...
function validateCheese(event) {
    ...
    setTimeout(() => {
            // document.getElementById("input-response").textContent = "";
            document.getElementById("input-response").classList.remove("visible");
